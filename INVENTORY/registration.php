...
<html lang="en">
  ...
  <body>
<h2 class="text-center" ><span style="color:blue">REGISTRATION ACCOUNT</span></h2>
<?php
...
<div class="card bg-light">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-7">
      <input type="text"  name="username" class="form-control" id="username" value="" placeholder="enter username" required>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="" class="col-sm-5 col-form-label">MOBILE</label>
    <div class="col-sm-7">
      <input type="text"  name="mobile" class="form-control" id="mobile" value="" placeholder="enter your mobile number" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="" class="col-sm-5 col-form-label">PASSWORD</label>
    <div class="col-sm-7">
      <input type="password"  name="password" class="form-control" id="password" value="" placeholder="enter your password" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="" class="col-sm-5 col-form-label">Confirm Password</label>
    <div class="col-sm-7">
      <input type="password"  name="cpassword" class="form-control" id="cpassword" value="" placeholder="enter confirm password" required>
    </div>
  </div>
