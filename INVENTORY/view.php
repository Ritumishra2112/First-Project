    ...
    <div class="container"  >
       ...
       <div class="container py-5">
        <div class="row ">
                    ...
                    <input type="text" placeholder="enter your item  name"value=<?php echo $name ?> name="name"  readonly class="form-control mb-4">
                    <label for="" class="text-uppercase text-sm mb-2">Rate</label>
                    <input type="decimal" placeholder=""value=<?php echo $rate ?> name="rate" readonly  class="form-control mb-2">
